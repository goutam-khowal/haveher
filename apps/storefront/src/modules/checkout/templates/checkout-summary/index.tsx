  ...
  return (
    <div className="sticky top-0 flex flex-col-reverse small:flex-col gap-y-6 py-6 small:py-0 font-sans text-[#3A1A2A]">
      <div className="w-full bg-white flex flex-col p-5 border border-pink-50/50 rounded-2xl shadow-sm">
        ...
        {/* Core Items Preview Container */}
        <div className="w-full select-none max-h-[350px] overflow-y-auto pr-1">
          <ItemsPreviewTemplate cart={cart} />
        </div>
      ...
      {/* 👑 CLUTTER REMOVED: Trust badges completely expelled from this section to make the checkout look ultra-premium */}
    </div>
  )
}
